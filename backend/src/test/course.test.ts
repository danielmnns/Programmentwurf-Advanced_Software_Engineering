...
describe('Course Endpoints', () => {
  ...
  it('should update an existing course', async () => {
    const course = await Course.create({ name: 'Update Course', description: 'Update Description' });
    const res = await request(app)
  ...
  it('should delete an existing course', async () => {
    const course = await Course.create({ name: 'Delete Course', description: 'Delete Description' });
